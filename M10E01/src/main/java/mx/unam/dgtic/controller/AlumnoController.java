...
import mx.unam.dgtic.servicio.AlumnoService;
...
public class AlumnoController {
    ...
    @PutMapping(path = "/{id}")
    public ResponseEntity<Alumno> updateAlumno(@PathVariable String id, @RequestBody Alumno alumno) throws URISyntaxException {
